...
export default function BooksClient({
  ...
  const [selectedGenre, setSelectedGenre] = useQueryState('genre', 'all');
  ...
  return (
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      ...
      {filteredBooks.length > elementsPerPage ? (
        <PageSelector
          pageCount={Math.ceil(filteredBooks.length / elementsPerPage)}
