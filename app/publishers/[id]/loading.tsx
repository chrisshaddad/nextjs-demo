export default function PublisherLoading() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-pulse">
      <div className="h-4 w-36 bg-zinc-200 dark:bg-zinc-700 rounded mb-6" />

      <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-8 mt-6 flex flex-col gap-5">
        <div className="h-10 w-72 bg-zinc-200 dark:bg-zinc-700 rounded" />
      ...
      <div className="mt-12">
        <div className="h-8 w-44 bg-zinc-200 dark:bg-zinc-700 rounded mb-6" />
